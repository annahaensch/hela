...
class DAG(nx.DiGraph):
    ...
    **Shortcuts:**
    ...
    def add_node(self, node, latent=False):
        ...
        super(DAG, self).add_node(node, latent=latent)
    ...
    def add_nodes_from(self, nodes, weights=None, latent=False):
        ...
        **The behviour of adding weights is different than in networkx.
        ...
        latent: list, tuple (default=False)
            A container of latent variables (boolean). If true, the node at
            index i is associated with a latent variable at index i.
    ...
    def add_edge(self, u, v, weight=None, latent=False):
        """
        ...
        {'weight': 0.1}
        """
        super(DAG, self).add_edge(u, v, weight=weight, latent=latent)

    def add_edges_from(self, ebunch, weights=None, latent=False):
        """
